...
def test_no_floating_resolution_delivery_or_commits_8_to_10():
    ...
    for forbidden in ("current_policy","latest_policy","newest_policy","published = column","delivered = column","dispatcher","scheduler","network","credentialbinding","generationfencerecord","calculationbundle"): assert forbidden not in combined
