"""RED attack: MEI value provenance must survive f-string publication."""

from __future__ import annotations


def test_mei_value_provenance_survives_fstring_publication_red(
    tmp_path,
    monkeypatch,
):
    ...
    (app_root / "bridge.py").write_text(
        ...
        "def publicar():\n"
        "    valor = produzir()\n"
        "    mensagem = f'DAS mensal: R$ {valor:.2f}'\n"
        "    return mensagem\n",
        encoding="utf-8",
    )
    ...
    assert provenance == [
        ...
        "app.bridge.publicar:mensagem:f-string",
