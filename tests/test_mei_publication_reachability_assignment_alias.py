"""RED: module-level assignment aliases must preserve canonical MEI reachability."""

from __future__ import annotations


def test_module_assignment_alias_resolves_to_canonical_mei_producer_red(
    tmp_path,
    monkeypatch,
):
    ...
    consumer_path.write_text(
        ...
        "\n"
        "producer_alias = calcular_das_mei\n"
        "\n"
        "def publicar():\n"
        "    return producer_alias()\n",
        encoding="utf-8",
    )
