...
|--------|-----|-------------------|
| `provado` | 81 | Teste verde cobrindo endpoint ou contrato HTTP |
| `parcial` | 9 | Teste de serviço/isolamento ou cobertura < 80% |
