...
|--------|-----|-------------------|
| `provado` | 87 | Teste verde cobrindo endpoint ou contrato HTTP |
| `parcial` | 3 | Teste de serviço/isolamento ou cobertura < 80% |
...
|-------|-----|---------------------|
| alto | 7 | D, E, G, O, F (memorial) |
| medio | 15 | I, J, H, L, M |
| baixo | 68 | A, B, C (parcial) |
