...
|--------|-----|-------------------|
| `provado` | 88 | Teste verde cobrindo endpoint ou contrato HTTP |
| `parcial` | 2 | Teste de serviço/isolamento ou cobertura < 80% |
...
|-------|-----|---------------------|
| alto | 6 | D, E, G, O, F (memorial) |
| medio | 15 | I, J, H, L, M |
| baixo | 69 | A, B, C (parcial) |
...
| E2 | POST `/fiscal/analisar-xml` | Análise XML assíncrona/síncrona | `tests/test_ops12_e2_analisar_xml_contract.py` | provado | baixo |
...
| F2 | POST `/relatorio/gerar-relatorio` | Preview JSON + persistência | `tests/test_ops12_f2_gerar_relatorio_contract.py` | provado | baixo |
...
| I14 | GET `/inteligencia/prioridade-auditoria/{id}` | Prioridade auditoria | `tests/test_ops12_i14_prioridade_auditoria_contract.py` | provado | baixo |
| I15 | GET `/inteligencia/projecao-recuperacao/{id}` | Projeção recuperação | `tests/test_ops12_i15_projecao_recuperacao_contract.py` | provado | baixo |
| I16 | GET `/inteligencia/risco-tributario/{id}` | Risco tributário | `tests/test_ops12_i16_risco_tributario_contract.py` | provado | baixo |
| I17 | GET `/inteligencia/eficiencia-tributaria/{id}` | Eficiência tributária | `tests/test_ops12_i17_eficiencia_tributaria_contract.py` | provado | baixo |
| I18 | GET `/inteligencia/complexidade-tributaria/{id}` | Complexidade tributária | `tests/test_ops12_i18_complexidade_tributaria_contract.py` | provado | baixo |
...
| L2 | POST `/ingestao/documentos` | Pipeline ingestão PDF/imagem | `tests/test_ingestion_campos_estruturados.py` (pipeline serviço) + `tests/test_ops12_l2_ingestao_documentos_contract.py` | provado | baixo |
